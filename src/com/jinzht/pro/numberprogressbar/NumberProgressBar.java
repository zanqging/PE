package com.jinzht.pro.numberprogressbar;
...
public class NumberProgressBar extends View {
    ...
    private void calculateDrawRectF() {
        ...
        mCurrentDrawText = df.format(getProgress() * 100 / getMax());
//        mCurrentDrawText = String.format("%d", getProgress() * 100 / getMax());
    ...
    public void incrementProgressBy(int by) {
        ...
        if(mListener != null){
            mListener.onProgressChange((int) getProgress(), getMax());
        }
    }
    ...
    public void setProgress(float progress) {
        if (progress==0){
            ...
            invalidate();
        }else if (/*progress <= getMax() && */progress >= 0) {
