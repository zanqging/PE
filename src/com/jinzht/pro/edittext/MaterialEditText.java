package com.jinzht.pro.edittext;
...
public class MaterialEditText extends EditText {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isFocused()) {
            ...
            highlightedColor = R.color.login_btn;
            labelTextColor = R.color.login_btn;
            if (imgIcon != null) {
        ...
        highlightedLinePaint.setColor(getResources().getColor(R.color.login_btn));
        ...
        if (floatingLabel && (isFocused() || getText().length() > 0 || labelAnimation != null)) {
            labelTextPaint.setColor(getResources().getColor(R.color.login_btn));
