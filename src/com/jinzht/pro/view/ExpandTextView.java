...
//    private Drawable mCollapseDrawable;
    ...
    public void onClick(View view) {
        ...
        mButton.setText(mCollapsed ? context.getResources().getString(R.string.all) : context.getResources().getString(R.string.shou));
    ...
    public void setText(@Nullable String text) {
        mRelayout = true;
//        mTv.setLineSpacing(0f, 1.2f);
//        mTv.setTextSize(10 * density);
//        mTv.setText(Html.fromHtml(text));
        mTv.setText(text);
//        new Thread(new Runnable() {
//            @Override
//            public void run() {
//                TextJustification.justify(mTv, size.x);
//            }
//        }).start();
