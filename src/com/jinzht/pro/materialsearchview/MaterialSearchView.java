...
import com.jinzht.pro.materialsearchview.utils.AnimationUtil;
...
//        mSuggestionsListView.setVisibility(GONE);
    ...
    public void setAdapters(ListAdapter adapter) {
        mAdapter = adapter;
        mSuggestionsListView.setAdapter(adapter);
    }
    ...
    public void setSuggestions(List<String> suggestions) {
        if (suggestions != null && suggestions.size() > 0) {
            mSuggestionsListView.setVisibility(VISIBLE);
            mTintView.setVisibility(VISIBLE);
            final NoFilterSearchAdapter adapter = new NoFilterSearchAdapter(mContext, suggestions, suggestionIcon);
            setAdapters(adapter);
            setOnItemClickListener(new AdapterView.OnItemClickListener() {
                @Override
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
