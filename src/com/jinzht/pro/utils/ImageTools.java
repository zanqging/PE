...
import com.jinzht.pro.cropimageview.RotateBitmap;
...
//						fileOutputStream.close();
	...
	public static void saveImageFile(Bitmap bm,String ALBUM_PATH, String fileName) throws IOException {
...
//设置好缩放比例后，加载图片进内容；
	...
	public static Bitmap compressByQuality(Bitmap bitmap, int maxSize) {
		...
		while (baos.toByteArray().length / 1024 > maxSize) {
			...
			baos.reset();
			bitmap.compress(Bitmap.CompressFormat.PNG, quality, baos);
			Log.e("sss","质量压缩到原来的" + quality + "%时大小为："
