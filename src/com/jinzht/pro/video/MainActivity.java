...
public class MainActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        video_back = (RelativeLayout) findViewById(R.id.video_back);
        video_back.setOnClickListener(new OnClickListener() {
            @Override
            ...
            switch (msg.what) {
                case 1:
                    if (mVideo.getCurrentPosition() > 0) {
                        mVideo.setBackgroundColor(getResources().getColor(R.color.transparent));
    ...
    private void playVideo() {
        mVideo.setVideoPath(getIntent().getStringExtra("path"));
        mVideo.requestFocus();
