...
public class PhotoItem extends LinearLayout implements OnCheckedChangeListener,
	...
	public void setImageDrawable(final PhotoModel photo) {
		 ...
		 * Random().nextInt(10));
		 */
		GlideUtils.loadImg(context,photo.getOriginalPath(),ivPhoto);
//		Glide.with(context)
//				.load( photo.getOriginalPath())
//				.into(ivPhoto);
//		UpLoadImageUtils.getSelectImage(context,"file://" + photo.getOriginalPath(),ivPhoto);
