...
public class Styled {
     ...
     * is an instance of {@link Spanned}, this method correctly
     * draws the text). See also
     * {@link Canvas#drawText(CharSequence, int, int, float,
     * float, Paint)} and
     * {@link Canvas#drawRect(float, float, float, float,
     * Paint)}.
     *
     ...
     *                  {@link Layout#DIR_LEFT_TO_RIGHT} or
