 ...
 * @time 21:26
 */
public class FinacingFragment extends BaseFragment implements SwipyRefreshLayout.OnRefreshListener {

    private CollectFinacingTask task;
    ...
    // 获取收藏的融资中列表数据并展示
    private class CollectFinacingTask extends AsyncTask<Void, Void, CollectWaitFinaceBean> {
        @Override
        ...
        protected CollectWaitFinaceBean doInBackground(Void... voids) {
            ...
            if (NetWorkUtils.getNetWorkType(mContext).equals(NetWorkUtils.NETWORK_TYPE_DISCONNECT)) {
                ...
                try {
                    body = OkHttpUtils.doGet(Constant.BASE_URL + Constant.PHONE + Constant.COLLECTFINACING + pageNO + "/", getActivity());
                    Log.i("收藏的融资中列表", body);
        ...
        protected void onPostExecute(CollectWaitFinaceBean waitList) {
            ...
            if (waitList != null) {
                ...
                adapter = new CollectNormalAdapter(getActivity(), arrayList, 1);
