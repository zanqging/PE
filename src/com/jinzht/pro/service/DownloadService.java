...
//		获得系统后台运行的NotificationManager服务
		Log.d("downloadservice", MainActivity.loading_process + "==");
...
//		addflag设置跳转类型
		...
		contentView.setTextViewText(R.id.n_title,
				getResources().getString(R.string.progress_update));
		contentView.setTextViewText(R.id.n_text, getResources().getString(R.string.progerss_now)+count+"% ");
