 ...
 *   然后在页面中调用ArrayList, ImageCycleViewListener) }即可!
 *   
...
public class ImageCycleView extends LinearLayout {
	 ...
	 */
	public void setImageResources(List<String> infoList, ImageCycleViewListener imageCycleViewListener) {
		// 清除所有子视图
		...
		for (int i = 0; i < imageCount; i++) {
			...
			if (i == 0) {
				mImageViews[i].setBackgroundResource(R.drawable.banner_square_select);
			} else {
				mImageViews[i].setBackgroundResource(R.drawable.banner_square_normal);
			}
	...
	private final class GuidePageChangeListener implements OnPageChangeListener {
		...
		public void onPageSelected(int index) {
			...
			mImageIndex = index;
			index -= 1;
			mImageViews[index].setBackgroundResource(R.drawable.banner_square_select);
